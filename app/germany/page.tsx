export default function Germany() {
    const topics = [
        { icon: "📘", title: "تجديد جواز السفر السوري", desc: "كيف تجدد جوازك من ألمانيا", href: "/germany/passport" },
        { icon: "👨‍👩‍👧", title: "لمّ شمل الأسرة", desc: "إحضار عائلتك إلى ألمانيا", href: "/germany/family" },
        { icon: "🎓", title: "الاعتراف بالشهادات", desc: "توثيق شهادتك الجامعية", href: "/germany/education" },
        { icon: "🏠", title: "الجنسية الألمانية", desc: "شروط وخطوات التجنيس", href: "/germany/citizenship" },
        { icon: "✈️", title: "العودة إلى سوريا", desc: "ما تحتاج معرفته قبل العودة", href: "/germany/return" },
    ];
